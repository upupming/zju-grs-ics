...
// 兼容浏览器和 node.js
typeof window === 'undefined' && (globalThis.atob = function (a) {
  return globalThis.Buffer && globalThis.Buffer.from(a, 'base64').toString('binary')
})

// 这一句必须要加一下，不然的话在 node.js 里面生成的加密码是错误的
// 估计是那段加密代码里面用到了 window === "undefined" 这样的条件语句
var window = globalThis

function t(e) {
  return (t = typeof Symbol === 'function' && typeof Symbol.A === 'symbol'
    ? function (e) {
      return typeof e
    }
    : function (e) {
...
s.prototype.e = function (e) {
  ...
  c.prototype.e = function (e) {
    e.Q.push(e.C),
      ...
      e.C = e.r[this.s],
      e.k = []
    for (let t = 0; t < this.i; t++) { e.k.unshift(e.f.pop()) }
    e.g.push(e.f),
      e.f = []
  }
  ,
...
Q.prototype.e = function (e) {
  ...
  G.prototype.D = function (e) {
    const t = atob(e)
    for (var n = t.charCodeAt(0) << 8 | t.charCodeAt(1), r = [], o = 2; o < n + 2; o += 2) { r.push(t.charCodeAt(o) << 8 | t.charCodeAt(o + 1)) }
    this.G = r
    for (var i = [], a = n + 2; a < t.length;) {
      const c = t.charCodeAt(a) << 8 | t.charCodeAt(a + 1)
      const u = t.slice(a + 2, a + 2 + c)
      i.push(u),
        a += c + 2
    }
    this.b = i
  ...
  ,
  // 这个估计是一段加密的代码，实现将 _encrypt 挂载在了 __g 上类似的操作
...
const b = function (e) {
  let encrypted = __g._encrypt(encodeURIComponent(e))
  encrypted = '2.0_' + encrypted.slice(0, -4)
  console.log('encrypted', encrypted)
  return encrypted
}

/* eslint-enable */
// console.log(b('44fd2b289432f1a8781bfced1c62eebd'))
